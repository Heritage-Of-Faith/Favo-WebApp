 ...
 * always, plus active-pack count when available. `activePackCount` is
 * optional so callers that only have partial data don't need to supply everything.
 */
...
export default function CustomerCard({ customer, activePackCount, onClear }: Props) {
  return (

...
ALTER TABLE "loyalty_transactions" ADD COLUMN "reason" text;--> statement-breakpoint
...
ALTER TABLE "pack_redemptions" ADD CONSTRAINT "pack_redemptions_order_id_orders_id_fk" FOREIGN KEY ("order_id") REFERENCES "public"."orders"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint

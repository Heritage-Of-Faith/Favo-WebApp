...
// WHERE kind = 'earn', defined in db/schema.ts and deployed via migration 0011.
//
...
const MIGRATION_PATH = resolve(process.cwd(), "drizzle/0011_loyalty_earn_idempotency.sql");
const SCHEMA_PATH = resolve(process.cwd(), "db/schema.ts");

describe("loyalty earn idempotency — migration 0011 (AT-60)", () => {
